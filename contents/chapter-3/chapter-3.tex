...
Jelaskan
\begin{itemize}
	\item{Arsitektur yang digunakan sebagai teacher}
	\item{Mengapa model tersebut dipilih}
	\item{Output yang dihasilkan → dalam kasusmu: pseudo depth}
\end{itemize}

\subsection{\textit{Student Model}}
Jelaskan
\begin{itemize}
	\item{Arsitektur student yang dilatih}
	\item{Apa yang dipelajari dari teacher}
	\item{Komponen yang terlibat → encoder, decoder, latent space}
\end{itemize}

\subsection{Sinyal Pelatihan}
Jelaskan
\begin{itemize}
	\item{Pseudo depth dari teacher}
	\item{Sparse ground truth}
	\item{Latent space dari encoder}
	\item{Latent space dari layer-layer decoder}
\end{itemize}

\subsection{Jenis Distillasi}
Bedakan dan jelaskan:
\begin{itemize}
	\item{Feature-based distillation → dari mana ke mana}
	\item{Response-based distillation → dari mana ke mana}
\end{itemize}
